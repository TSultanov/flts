        ...
        port.onmessage = (ev: MessageEvent) => {
            ...
            try {
                if (action === 'createBookFromText') {
                    ...
                    port.postMessage({ id, result });
                } else if (action === 'getBookChapters') {
