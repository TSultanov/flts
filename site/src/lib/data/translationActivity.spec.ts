...
type Store =
  (typeof import("./translationActivity.svelte"))["activeTranslations"];
...
const started = (
  ...
  hub.emit("paragraph_translation_started", {
    bookId,
    paragraphId,
    requestId,
    expectedChars,
...
const progress = (
  ...
  hub.emit("paragraph_translation_progress", {
    bookId,
    paragraphId,
    requestId,
    progressChars,
...
const finished = (
  ...
  hub.emit("paragraph_translation_finished", {
    bookId,
    paragraphId,
    requestId,
    error,
