    ...
    chapters: [
      {
        title: "Chapter One",
        content:
          "<p>This is the first paragraph of chapter one.</p><p>This is the second paragraph with some <em>italic</em> and <b>bold</b> text.</p>",
      },
      {
        title: "Chapter Two",
        content:
          "<p>Chapter two begins here.</p><p>It has multiple sentences. Some of them are longer than others.</p><p>The final paragraph of chapter two.</p>",
      },
    ],
  });
}
    ...
    chapters: [
      {
        ...
        content:
          "<p>Hello, world! This is English text.</p><p>How are you today? I hope you are well.</p>",
      },
      {
        title: "Spanish Chapter",
        content:
          "<p>¡Hola, mundo! Este es texto en español.</p><p>¿Cómo estás hoy? Espero que estés bien.</p>",
      },
      {
        title: "French Chapter",
        content:
          "<p>Bonjour, monde! Ceci est du texte français.</p><p>Comment allez-vous aujourd'hui? J'espère que vous allez bien.</p>",
      },
      {
        title: "Mixed Language Chapter",
        content:
          "<p>This paragraph starts in English, pero luego cambia al español, et finit en français.</p>",
      },
    ],
  });
}
